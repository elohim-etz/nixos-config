{
  ...
  # Follow upstream
  # https://github.com/Stremio/stremio-linux-shell/blob/v1.0.0-beta.13/flatpak/com.stremio.Stremio.Devel.json
...
in
  rustPlatform.buildRustPackage (finalAttrs: {
    ...
    cargoLock = {
      ...
      outputHashes = {
        # some hashes are missing from the cargo lockfile
