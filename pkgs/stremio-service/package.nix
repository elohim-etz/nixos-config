# https://github.com/NixOS/nixpkgs/blob/master/pkgs/by-name/st/stremio-service/package.nix
{
  lib,
  stdenv,
  fetchurl,
...
let
  ...
  server = fetchurl rec {
    ...
    hash = "sha256-QF60lNZwhAajDnFsPPtauuel6ceot5RG1kw/ghOFkw8=";
...
rustPlatform.buildRustPackage (finalAttrs: {
  ...
  src = fetchFromGitHub {
    ...
    hash = "sha256-im1oW49rIW8r66ksfG+FrGduG6+n/P74lELWoE6Tp78=";
  };
  ...
  cargoHash = "sha256-f7waAaii1hOIaP3itplx7sNRMkDOOIFcNyHOQF2WZ+E=";
  buildFeatures = [
    "offline-build"
    "bundled"
  ];
